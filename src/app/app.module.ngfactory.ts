...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  get _LOCALE_ID_4():any {
    if ((this.__LOCALE_ID_4 == null)) { (this.__LOCALE_ID_4 = 'es'); }
  ...
  get _TRANSLATIONS_FORMAT_29():any {
    if ((this.__TRANSLATIONS_FORMAT_29 == null)) { (this.__TRANSLATIONS_FORMAT_29 = 'xlf'); }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import26.TRANSLATIONS_FORMAT)) { return this._TRANSLATIONS_FORMAT_29; }
